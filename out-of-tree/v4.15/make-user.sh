...
#This compiles in statically (see .a) against the kernel source
...
LIBBPF_LOC="/home/atr/vu/github/libbpf/"
# This compiles against the libbpf code
gcc cpustat_user.c ./from_kernel/bpf_load.c $LIBBPF_LOC/src/libbpf.a -I"$LIBBPF_LOC/src/" -I./from_kernel/ $CFLAGS -lelf -o cpustat
