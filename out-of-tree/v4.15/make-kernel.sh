#!/bin/bash
COPTS="-O2 -D__KERNEL__ -Wno-unused-value -Wno-pointer-sign -D__TARGET_ARCH_x86 -Wno-compare-distinct-pointer-types -Wno-gnu-variable-sized-type-not-at-end -Wno-address-of-packed-member -Wno-tautological-compare -Wno-unknown-warning-option"
...
set -x 
clang -target bpf -nostdinc $INCX $COPTS -emit-llvm -c cpustat_kern.c -o - | llc -march=bpf -filetype=obj -o cpustat_kern.o
file cpustat_kern.o 
